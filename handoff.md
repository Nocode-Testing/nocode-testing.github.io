...
- Node.js >= 18 est declare dans `package.json` ; Node.js 22 LTS est recommande avec la future stack, sous validation du commanditaire.
- Le MVP publie les articles depuis Markdown versionne dans Git. Eleventy est recommande pour generer le HTML, avec CSS et JavaScript natif ; ce choix ne requiert pas de base de donnees.
...
## Points d'attention
- Reste a valider : Eleventy/Node 22. La direction visuelle de reference MVP est `assets/mockups/accueil-puzzle-ateliers-themes.svg`.
...
## Prochaines etapes
- Valider la stack Eleventy/Node 22, puis cadrer l'accueil/header a partir de la maquette de reference.
- Rediger et faire relire humainement la politique de confidentialite avant le lot formulaire.
